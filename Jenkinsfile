pipeline {
    ...
    post {
        always {
            ...
            archiveArtifacts artifacts: 'target/tasks-backedn.war, frontend/target/tasks.war', followSymlinks: false, onlyIfSuccessful: true
        }
        unsuccessful {
            emailext attachLog: true, body: 'See the attached log below', subject: 'Build $BUILD_NUMBER has failed', to: 'dsl15021996@gmail.com'
        }
        fixed {
            emailext attachLog: true, body: 'See the attached log below', subject: 'Build is fine!!!', to: 'dsl15021996@gmail.com'
        }
    }
}
